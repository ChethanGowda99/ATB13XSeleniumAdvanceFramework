...
public class TestVWO_Login_01_ScreenshotListener extends CommonToAll
{

    private static final Logger logger = LogManager.getLogger(TestVWO_Login_01_ScreenshotListener.class);
